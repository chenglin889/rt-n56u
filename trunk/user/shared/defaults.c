...
struct nvram_pair router_defaults[] = {
	...
	{ "koolproxy_txt_2", "https://houzi-.coding.net/p/my_dream/d/my_dream/git/raw/master/koolproxy.txt"},
	{ "daily_txt_2", "https://houzi-.coding.net/p/my_dream/d/my_dream/git/raw/master/daily.txt"},
	{ "kp_dat_2", "https://houzi-.coding.net/p/my_dream/d/my_dream/git/raw/master/kp.dat"},
	{ "koolproxy_update", "2"} ,
	{ "koolproxy_update_hour", "3" },
	{ "kolproxy_update_min", "30" },
 	{ "ss_DNS_Redirect", "0" },
	{ "kp_ip_x", "0" },
	{ "kp_staticnum_x", "0" },
